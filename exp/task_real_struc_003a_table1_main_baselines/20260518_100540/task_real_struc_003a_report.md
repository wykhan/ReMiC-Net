...
BP uses `workspace.recon.cyl_true_bp_engine.true_backproject_sparse_echo`, not the reference-surface cache. BP runtime mean is 0.931354 s/sample and speedup is fixed to 1.0.
...
6. Speedup relative to BP: 2.4427x.
